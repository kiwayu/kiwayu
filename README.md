...
- 🔧 Building scalable data pipelines and full-stack applications
...
- 🏗️ Data modeling and warehouse architecture
- ☁️ Cloud infrastructure with Azure
- 🔐 Building secure, scalable microservices
- 🤖 Exploring AI/ML integration tooling
