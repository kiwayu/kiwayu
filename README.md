...
- 🎓 Computer Science Student (on track for First-Class Honours)
- 💼 Marketing & Creative Manager turned Software Engineer
- 🔧 Building scalable data pipelines, full-stack applications, and AI-powered tooling
...
![Great Expectations](https://img.shields.io/badge/Great%20Expectations-FF6B6B?style=for-the-badge&logo=python&logoColor=white)
...
- 🏗️ Data modelling and warehouse architecture
- 📱 Cross-platform mobile development with React Native and Expo
- ☁️ Cloud infrastructure with AWS and Azure
- 🔐 Building secure, scalable microservices
- 🤖 AI/ML integration and LLM-powered tooling
